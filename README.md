<h1 align="center">把零散 Prompt，整理成可直接复用的 AI 工作流</h1>

<p align="center"><strong>KeRo AI Prompt Library</strong></p>

<p align="center">文案 · 电商 · TikTok · 翻译 · AI 生图 · 视频分镜 · 自动化</p>
...
当前版本从原始 SOP 文档中整理出 **9 个主题分类、88 个实用 Prompt 和 11 个进阶 Prompt 包**，并配套 73 张正文示例图。

## 核心价值

| 能力 | 解决的问题 |
|---|---|
| 结构化 Prompt | 从一句模糊需求变成可执行的角色、任务、约束和交付格式 |
| 电商实战导向 | 围绕详情页、广告、短视频、TikTok 和视觉设计直接落地 |
| 中泰本地化 | 覆盖中文、泰语口语化翻译、双语时间轴和泰国市场内容 |
| 图像与视频工作流 | 从图片解析、首尾帧到多宫格分镜和 Seedance 视频提示词 |
| 事实与风险约束 | 明确要求核验数据、产品卖点、平台规则和素材权利 |
| 可持续迭代 | 内置二次改写、审核、补全和多版本输出方法 |

## Prompt 分类

点击下面任意 Prompt 名称，可直接跳到对应内容。

| 分类 | Prompt 名称（点击直达） |
|---|---|
| **01 · 市场分析与自动化** | [美股收盘日报自动化](prompts/01-market-automation.md#us-market-daily-report) |
| **02 · 翻译、音频与文本润色** | [提取音频与双语时间轴](prompts/02-translation-and-polishing.md#extract-audio-bilingual-timeline)<br>[视频 / 音频双语翻译](prompts/02-translation-and-polishing.md#audio-video-bilingual-translation)<br>[中文转泰语本地化](prompts/02-translation-and-polishing.md#zh-to-th-localization)<br>[泰语本地化二次迭代](prompts/02-translation-and-polishing.md#thai-localization-iteration)<br>[文本润色：优雅版与口语版](prompts/02-translation-and-polishing.md#text-polishing) |
| **03 · 文案、电商与广告** | [抖音文案角色设定](prompts/03-copywriting.md#douyin-copywriting-role)<br>[泰国 TikTok 墨镜文案](prompts/03-copywriting.md#thai-tiktok-sunglasses-copy)<br>[通用高质量 Prompt 母模板](prompts/03-copywriting.md#universal-prompt-template)<br>[爆款标题](prompts/03-copywriting.md#viral-headlines)<br>[小红书种草笔记](prompts/03-copywriting.md#xiaohongshu-post)<br>[朋友圈 / 社群短文案](prompts/03-copywriting.md#social-copy)<br>[电商详情页文案](prompts/03-copywriting.md#ecommerce-detail-copy)<br>[信息流广告 A/B 变体](prompts/03-copywriting.md#feed-ad-ab)<br>[15 / 30 / 60 秒短视频脚本](prompts/03-copywriting.md#short-video-15-30-60)<br>[品牌 Slogan / 一句话定位](prompts/03-copywriting.md#brand-slogan)<br>[二次迭代 Prompt](prompts/03-copywriting.md#prompt-iteration)<br>[按需求生成 Prompt](prompts/03-copywriting.md#prompt-generator) |
| **04 · 短视频与 TikTok 运营** | [短视频脚本创作](prompts/04-short-video-and-tiktok.md#short-video-script)<br>[资深短视频编导](prompts/04-short-video-and-tiktok.md#short-video-director)<br>[千川高转化短视频编剧](prompts/04-short-video-and-tiktok.md#qianchuan-video-writer)<br>[视频转中文知识笔记](prompts/04-short-video-and-tiktok.md#video-to-chinese-notes)<br>[TikTok 运营文案审核](prompts/04-short-video-and-tiktok.md#tiktok-copy-review)<br>[TikTok 文案审核二次迭代](prompts/04-short-video-and-tiktok.md#tiktok-copy-review-iteration)<br>[泰国 TikTok 痛点深挖](prompts/04-short-video-and-tiktok.md#thai-tiktok-pain-points)<br>[视频口播文案提取](prompts/04-short-video-and-tiktok.md#spoken-copy-extraction)<br>[AI 动漫短剧编剧](prompts/04-short-video-and-tiktok.md#ai-animation-writer) |
...
1. 先选最接近任务的分类。
2. 展开 Prompt，复制代码块。
3. 替换 `{产品}`、`{受众}`、`{平台}`、`{目标}` 等变量。
4. 把真实产品资料、参考图或脚本一起交给 AI。
5. 用同一页的迭代 Prompt 做第二轮修改，不要把第一版直接当成终稿。
